    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="xunchongxinxiName">
                       <el-input v-model="ruleForm.xunchongxinxiName"
                                 placeholder="标题" clearable  :readonly="ro.xunchongxinxiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="标题" prop="xunchongxinxiName">
                           <el-input v-model="ruleForm.xunchongxinxiName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xunchongxinxiPhoto" label="宠物图片" prop="xunchongxinxiPhoto">
                        <file-upload
                            tip="点击上传宠物图片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.xunchongxinxiPhoto?ruleForm.xunchongxinxiPhoto:''"
                            @change="xunchongxinxiPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xunchongxinxiPhoto" label="宠物图片" prop="xunchongxinxiPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.xunchongxinxiPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <div v-if="type=='info'">
                        <el-form-item class="input" label="寻宠状态" prop="jieshuValue">
                        <el-input v-model="ruleForm.jieshuValue"
                            placeholder="寻宠状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="宠物详情" prop="xunchongxinxiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xunchongxinxiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xunchongxinxiContent" label="宠物详情" prop="xunchongxinxiContent">
                            <span v-html="ruleForm.xunchongxinxiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    xunchongxinxiName: false,
                    chongwuTypes: false,
                    xunchongxinxiPhoto: false,
                    xunchongxinxiMoney: false,
                    yonghuId: false,
                    jieshuTypes: false,
                    xunchongxinxiContent: false,
                },
                ruleForm: {
                    xunchongxinxiName: '',
                    chongwuTypes: '',
                ...
                rules: {
                   ...
                   xunchongxinxiMoney: [
                              { required: true, message: '已获捐数值不能为空', trigger: 'blur' },
                   ...
                   jieshuTypes: [
                              { required: true, message: '寻宠状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xunchongxinxi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xunchongxinxiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            xunchongxinxiPhotoUploadChange(fileUrls){
                this.ruleForm.xunchongxinxiPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },

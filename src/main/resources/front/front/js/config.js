...
var indexNav = [
    ...
    {
        name: '寻宠请求',
        url: './pages/xunchongxinxi/list.html'
    },

]

var adminurl =  "http://localhost:8080/liulangdongwujiuzhug/admin/dist/index.html#/login";

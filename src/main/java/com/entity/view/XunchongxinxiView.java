...
public class XunchongxinxiView extends XunchongxinxiEntity implements Serializable {
	...
	public XunchongxinxiView() {

	}

	public XunchongxinxiView(XunchongxinxiEntity xunchongxinxiEntity) {
		try {
			BeanUtils.copyProperties(this, xunchongxinxiEntity);

    ...
    */
    ...
    public R save(@RequestBody ChongwuEntity chongwu, HttpServletRequest request){
        ...
        Wrapper<ChongwuEntity> queryWrapper = new EntityWrapper<ChongwuEntity>()
            ...
            .eq("status_types", chongwu.getStatusTypes())
            .eq("jieshu_types", chongwu.getJieshuTypes())
            ;
...
//                            chongwuEntity.setChongwuTypes(Integer.valueOf(data.get(0)));   //动物类型 要改的
//                            chongwuEntity.setStatusTypes(Integer.valueOf(data.get(0)));   //数据类型 要改的
//                            chongwuEntity.setChongwuPhoto("");//详情和图片
//                            chongwuEntity.setChongwuMoney(data.get(0));                    //已获捐数值 要改的
//                            chongwuEntity.setJieshuTypes(Integer.valueOf(data.get(0)));   //认领状态 要改的

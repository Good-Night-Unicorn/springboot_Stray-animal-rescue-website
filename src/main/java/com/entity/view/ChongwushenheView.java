...
public class ChongwushenheView extends ChongwushenheEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 申请状态的值
		*/
		private String chongwushenheYesnoValue;
	...
	public ChongwushenheView() {

	}

	public ChongwushenheView(ChongwushenheEntity chongwushenheEntity) {
		try {
			BeanUtils.copyProperties(this, chongwushenheEntity);
			...
			* 获取： 申请状态的值
			*/
			public String getChongwushenheYesnoValue() {
				return chongwushenheYesnoValue;
			}
			/**
			* 设置： 申请状态的值
			*/
			public void setChongwushenheYesnoValue(String chongwushenheYesnoValue) {
				this.chongwushenheYesnoValue = chongwushenheYesnoValue;
			}
